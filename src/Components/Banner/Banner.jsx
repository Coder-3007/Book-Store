      ...
      <div className="py-10">
        <div className=" container">
          <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6">
            ...
            <div
              data-aos="slide-up"
              className="flex flex-col justify-center gap-6 sm:pt-6"
            >
              <h1 className="text-3xl sm:text-4xl font-bold">
                Library at your Finger Tips
              </h1>
              <p className="text-sm to-gray-500 tracking-wide leading-5">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                Laborum mollitia corporis voluptas hic maxime, iusto quo nihil
                voluptatum nostrum, commodi molestiae lorem.
              </p>
